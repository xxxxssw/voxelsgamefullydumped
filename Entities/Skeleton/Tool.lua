-- Roblox script dump
-- ClassName: Script
-- Path: ReplicatedStorage.Assets.Entities.Skeleton.Tool
-- Source: decompile
...
if script:IsDescendantOf(v1) then
    ...
    local v3 = require(game.ReplicatedStorage.Systems.ItemsSystem.UtilsItems).itemIdFromName("iron_sword")
    local v4 = script.Parent
    local v5 = v4:WaitForChild("RightArm", (1 / 0))
