...
-- Path: ReplicatedStorage.Assets.TextureProvider.TexturesLinker.mineclone
-- Source: decompile
...
local v2 = {
    ...
    ["dark_oak_log"] = {
        ["Default"] = "log_dark_oak",
        ["Top"] = "log_dark_oak_top",
        ["Bottom"] = "log_dark_oak_top"
    },
    ["oak_log"] = {
        ["Default"] = "log_oak",
        ["Top"] = "log_oak",
