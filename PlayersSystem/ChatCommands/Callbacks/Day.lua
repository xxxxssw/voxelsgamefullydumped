...
-- Path: ReplicatedStorage.Systems.PlayersSystem.ChatCommands.Callbacks.Day
-- Source: decompile
...
function v5.run(_, p7, _) --[[ Line: 16 ]]
    ...
    u4.Value = (math.floor(v8) + 1) * u6 + u3.HOUR_LENGTH * (u3.DAY_SECTIONS.DAY.Min + 2)
    p7("Day set", Color3.fromRGB(255, 255, 127))
end
return v5