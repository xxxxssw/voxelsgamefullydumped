...
-- Path: ReplicatedStorage.Systems.InventorySystem.Formats.Altar
-- Source: decompile
...
local u6 = {
    ...
    ["size"] = 2,
    ["constraints"] = {
        [v3.Item] = v2.canBeEnchanted,
        [v3.Enchantment] = v2.canBeUsedToEnchant
    },
    ["createEmpty"] = function() --[[ Name: createEmpty, Line 18 ]]
        --[[
        Upvalues:
            [1] = u6
            [2] = u1
